...
<head>
	...
	<title>User List | INV MNG SYS</title>
				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						<div class="card-header py-3 d-sm-flex align-items-center justify-content-between align-items-center">
							...
							<a href="addUser.php" class="btn btn-sm btn-primary shadow-sm d-flex justify-content-center align-items-center">Add &nbsp;<i
											...
											while($row = $result->fetch_assoc()) {
												echo "
														<tr>
																...
																<td>{$row['usertype']}</td>
																<td>
																		<a class=\"btn btn-success btn-sm\" href=\"editUser.php?id={$row['id']}\">Edit</a>
